        ...
        <section class="mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <h2 class="h5-responsive font-weight-bold text-center my-5;">Update the Selected Product</h2>
                    <hr class="style1" style="margin-bottom: 20px;">

                    <div class="container ">
                        <div class="row justify-content-center ">

                            <form action="/UpdateProduct/{{ $Products[0]->id }}" method="POST" id="contactform">
                                @csrf
