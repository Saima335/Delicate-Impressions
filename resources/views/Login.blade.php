...
<head>
    ...
    <title>Login - Delicate Impressions</title>
...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="container"
                style="margin-top: 2%;  background-color:rgba(182, 116, 116, 0.3); border-radius: 20px; overflow: hidden;">
                <section class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-md-0 mb-5">
                            ...
                            <h2 class="h1-responsive font-weight-bold text-center my-5;"
                                style="color:rgba(255, 255, 255, 0.664)">Sign In</h2>
                            <hr class="style1">
                            ...
                            <form id="contactform" action="login" method="POST">
                                ...
                                <div class="text-center text-md-left">
                                    <p style="color: rgba(245, 245, 245, 0.719);">Don't have an account yet?
            ...
            <div class="container text-center text-md-left mt-5">
                <div class="row">
                    ...
                    <div class="col-md-3 mx-auto mb-4">
                        ...
                        <p class="mt-2">
                            <center-align>We offer outfits that are chic yet practical, topped with trendsetting
                                designs. We strive to inspire young girls to maintain positive self-expression and fear
                                none while following the latest trend.</center-align>
                        </p>
                    </div>
