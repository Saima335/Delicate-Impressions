...
<head>
    ...
    <title>Summer Collection - Delicate Impressions</title>
...
<body>
    ...
    <img src="https://roycollections.com/wp-content/uploads/2020/06/limelight-unstitched-summer-collection.jpg"
        alt="Sale" width="100%" height="450px" style="margin-top:-20px">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/SummerCollection">Summer Collection<span style="font-size:16px;"
            ...
            <div class="row">
                ...
                @foreach ($Products as $Product)
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <form action="/SummerCollectionCart/{id}" method="POST">
                            @csrf
                            ...
                            <div class="shadoweffects">
                                ...
                                <div class="overlay">
                                    <h2>{{ $Product->Title }}</h2>
                                    <a href="SummerCollectionCart/{{ $Product->id }}" class="info"
