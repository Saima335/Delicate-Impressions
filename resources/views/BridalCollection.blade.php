...
<head>
    ...
    <title>Bridal Collection - Delicate Impressions</title>
...
<body>
    ...
    <img src="https://cdn.shopify.com/s/files/1/0037/1307/3261/files/Website_Banner_02_444f2976-3079-4195-bbb4-8cc792c86652.jpg?v=1597764073"
        alt="Sale" width="100%" height="550" style="margin-top:-20px">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="/Browse">Browse<span style="font-size:16px;"
                    ...
                    <li class="active"><a href="/BridalCollection">Bridal Collection<span style="font-size:16px;"
                                class="pull-right hidden-xs showopacity glyphicon glyphicon-circle-arrow-right"></span></a>
                    </li>
            ...
            <div class="row">
                ...
                @foreach ($Products as $Product)
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <form action="/BridalCollectionCart/{id}" method="POST">
                            @csrf
                            ...
                            <div class="shadoweffects">
                                ...
                                <div class="overlay">
                                    <h2>{{ $Product->Title }}</h2>
                                    <a href="BridalCollectionCart/{{ $Product->id }}" class="info"
                                        style="margin-top:10%" type="submit" name="Add" style="color: white;">Add to
                                        Cart</a>
                                </div>
                                <div class="card-body">
