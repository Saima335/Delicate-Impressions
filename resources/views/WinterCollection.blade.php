...
<head>
    ...
    <title>Winter Collection - Delicate Impressions</title>
...
<body>
    ...
    <img src="https://www.junaidjamshed.com/media/wysiwyg/Banner_3.jpg" alt="Sale" width="100%" height="450"
        style="margin-top:-20px">

    <!---------------------------------------------------------------------------------------------------------------------->


    <nav class="navbar navbar-inverse sidebar" role="navigation" margin="-120px">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/WinterCollection">Winter Collection<span style="font-size:16px;"
                                class="pull-right hidden-xs showopacity glyphicon glyphicon-circle-arrow-right"></span></a>
                    </li>
            ...
            <div class="row">
                ...
                @foreach ($Products as $Product)
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6">
                        <form action="/WinterCollectionCart/{id}" method="POST">
                            @csrf
                            ...
                            <div class="shadoweffects">
                                ...
                                <div class="overlay">
                                    <h2>{{ $Product->Title }}</h2>
                                    <a href="WinterCollectionCart/{{ $Product->id }}" class="info"
                                        style="margin-top:90%" type="submit" name="Add" style="color: white;">Add to
                                        Cart</a>
                                </div>
                                <div class="card-body">
